...
public class ConversationQueryService implements GetConversationUseCase {
    ...
    @Override
    public List<Conversation> findAll(UUID userId, String cursor, String idAfter, int limit,
                                      String sortDirection, String sortBy) {
        boolean ascending = "ASC".equalsIgnoreCase(sortDirection);
        return loadConversationPort.findAll(userId, cursor, idAfter, limit + 1, ascending, sortBy);
    }
